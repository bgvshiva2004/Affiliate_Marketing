	...
	return (
		<div className='relative min-h-screen overflow-hidden'>
			...
			<div className=" relative  bg-gradient-to-br from-gray-50 to-gray-100">
				...
				{isListVisible && (
					<div className="fixed top-0 left-0 w-full h-full z-[100000] overflow-auto bg-white/80 backdrop-blur-sm p-4 sm:p-6 transition-opacity duration-300 ease-in-out">
						<div className="flex justify-between items-center mb-4">
							<h2 className="text-xl sm:text-2xl font-bold text-black">Your Items</h2>
							<Button
								variant="ghost"
								size="icon"
				...
				<motion.div
					className="fixed bottom-[-60px] left-0 right-0 shadow-lg  z-[10000]"
					initial={{ height: '60px' }}
					animate={controls}
				...
				>
					<motion.div
						...
						className="cursor-grab active:cursor-grabbing relative z-[10000]"
					>
						<svg
